...
class hyperParameters(object):
    ...
    def __init__(self):
        ...
        # self.max_steps = 5000
        # self.batch_size = 64
        self.total_episodes = 201  # INTIALLY  5000
        self.max_steps = 5000
        self.batch_size = 64

        # Fixed Q target hyper parameters
        # self.max_tau = 5000  # tau is the C step where we update out target network -- INTIALLY 10000
        self.max_tau = 1000  # tau is the C step where we update out target network -- INTIALLY 10000
        ...
        self.pretrain_length = 5000  ## Number of experiences stored in the Memory when initialized for the first time --INTIALLY 100k
        self.memory_size = 5000  # Number of experiences the Memory can keep  --INTIALLY 100k

        self.load_memory = True # If True load memory, otherwise fill the memory with new data
        self.memory_load_path = "replay_memory/memory_rgb.pkl"
        self.memory_save_path = "replay_memory/memory_rgb.pkl"
        # self.memory_load_path = "replay_memory/memory_hdmap.pkl"
        # self.memory_save_path = "replay_memory/memory_hdmap.pkl"

        # model saving
        self.model_save_frequency = 10 # frequency to save the model. 0 means not to save
        self.model_name = "DQNetwork"
        self.model_path = "model_rgb"
        self.model_save_path = "model_rgb/rl_model.ckpt"
        # self.model_path = "model_hdmap"
        # self.model_save_path = "model_hdmap/rl_model.ckpt"
